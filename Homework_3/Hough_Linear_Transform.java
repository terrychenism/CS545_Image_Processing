...
public class Hough_Linear_Transform implements PlugInFilter {
	...
	public void run(ImageProcessor ip) {
		...
		List<LinearHT.HoughLine> lines = ht.getMaxLines(MaxLines, MinPointsOnLine);
		...
		if (ListStrongestLines) {
			int i = 0;
			for (LinearHT.HoughLine hl : lines){
	 ...
	 */
	private void drawLine(ImageProcessor ip, LinearHT.HoughLine hl) {
